...
def extract_garc(filepath):

    while True:
        write_dir = askdirectory(title = 'Select folder to write extracted files to')
...
def build_garc(folder_path):

    
    write_file = asksaveasfilename(title = 'Choose GARC to build')
...
def main():
    while True:
        ...
        while True:
            ...
            match input('(E)xtract GARC\n(B)uild GARC\n(D)ecompress Folder\n(C)ompress Folder\n(D)ecompress (F)ile\n(C)ompress (F)ile\n(Q)uit\n\n').lower():
                case 'e':
                    extract_garc(askopenfilename(title = 'Select GARC to extract'))
                case 'b':
                    build_garc(askdirectory(title = 'Select folder to build into GARC'))
                case 'd':
                    decompress_folder(askdirectory(title = 'Select folder to decompress'))
                case 'c':
